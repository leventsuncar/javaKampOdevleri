...
public class HPQKPSPublicSoap
{
    ...
    public HPQKPSPublicSoap(){}

    public HPQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HPQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HPQExtendedSoapSerializationEnvelope envelope= new HPQExtendedSoapSerializationEnvelope(HPQExtendedSoapSerializationEnvelope.VER11);
